...
CHALLENGES = [
    ...
    Challenge(
        ...
        acceptance_criteria=[
            ...
            "GET /time returns ISO timestamp",
            "GET /echo?msg=test returns test",
        ],
    ...
    Challenge(
        ...
        acceptance_criteria=[
            ...
            "HTML endpoint renders markdown",
            "Tags filterable",
        ],
        verify_commands=["curl localhost:8000/docs"],
    ...
    Challenge(
        ...
        acceptance_criteria=[
            ...
            "Order service CRUD works",
            "Order creation validates user exists",
    ...
    Challenge(
        ...
        acceptance_criteria=[
            ...
            "Average endpoint works",
            "Group-by endpoint works",
        ],
        verify_commands=["curl localhost:8001/docs", "curl localhost:8002/docs"],
        timeout_seconds=1500,
    ...
    Challenge(
        ...
        acceptance_criteria=[
            "Product CRUD works",
            "Review CRUD works",
            "Catalog aggregates products with ratings",
            "Average rating calculated correctly",
            "All three services have health endpoints",
        ],
        verify_commands=[
            "curl localhost:8001/docs",
            "curl localhost:8002/docs",
            "curl localhost:8003/docs",
        ],
    ...
    Challenge(
        ...
        acceptance_criteria=[
            "GET /items?page=1&size=10 returns paginated results",
            "X-Total-Count header present",
            "Default page=1, size=20",
            "Existing POST/PUT/DELETE still work",
        ],
    ...
    Challenge(
        ...
        acceptance_criteria=[
            "GET /notes/search?q=keyword works",
            "Searches title and content",
            "Returns matching notes",
            "Existing CRUD endpoints unaffected",
        ],
    ...
    Challenge(
        ...
        acceptance_criteria=[
            ...
            "Task endpoints reject requests without token",
            "Task endpoints work with valid token",
            "Invalid token returns 401",
        ],
        verify_commands=[
            'curl -X POST localhost:8000/login -H \'Content-Type: application/json\' -d \'{"username":"admin","password":"admin123"}\''
        ],
        timeout_seconds=900,
    ...
    Challenge(
        ...
        acceptance_criteria=[
            "GET /expenses/export returns CSV",
    ...
    Challenge(
        ...
        acceptance_criteria=[
            "Accepts address as CLI arg",
            "Uses ethers v6 top-level imports",
            "Prints balance in ETH",
            "Does NOT use ethers.providers or BigNumber",
    ...
    Challenge(
        ...
        acceptance_criteria=[
            ...
            "POST /mcp handles MCP protocol",
            "echo tool returns input text",
            "word_count tool returns count",
            "Uses correct MCP SDK subpath imports with .js",
    ...
    Challenge(
        ...
        verify_commands=[
            'python -c \'import importlib, sys; sys.path.insert(0, "."); importlib.import_module("main")\''
        ],
        timeout_seconds=300,
...
async def run_benchmark(
    ...
    for tier in sorted(set(r.tier for r in results)):
        ...
        print(
            f"  Tier {tier} ({tier_label}): {tier_pass}/{len(tier_results)} pass, {tier_exec}/{len(tier_results)} executor"
        )
            ...
            [
                {
                    ...
                    "cost": r.cost_usd,
                    "time": r.build_time_seconds,
                    "executor_passed": r.executor_passed,
                    "error": r.error,
                }
                for r in results
            ],
